...
#Задание 29.2.24
#Создайте пустой кортеж tpl, используя конструктор типов tuple(). 
#Выведите полученный результат. В качестве ответа напишите результат вывода.
tpl = tuple()
print(tpl);
#answer - ()
...
#Задание 29.2.26
#Создайте кортеж tpl3 c тремя числами: 15, 22 и 0. Выведите результат. 
#В качестве ответа запишите результат вывода.
tpl3 = (15, 22, 0)
print(tpl3);
#answer - (15, 22, 0)